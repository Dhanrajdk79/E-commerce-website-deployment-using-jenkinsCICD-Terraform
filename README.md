...
```bash
git clone https://github.com/Dhanrajdk79/E-commerce-website-deployment-using-jenkinsCICD-Terraform.git
...
```bash
public_key_path "C:\Users\admin\Downloads\try.pem"
...
pipeline {
  agent any
  environment {
    GITHUB_REPO_URL = "https://github.com/Dhanrajdk79/E-commerce-website-deployment-using-jenkinsCICD-Terraform.git"
    GIT_BRANCH = "master2"
    SSH_CRED_ID = "web-key"
